      ...
      <main>
        ...
        <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto text-white">
            ...
            >
              <span className="text-[#F06934] font-bold tracking-widest uppercase mb-4 block">Articles & News</span>
        ...
        {isLoading ? (
          ...
          articles.map((item) => (
            ...
            >
              <div className="relative h-56 -mt-6 overflow-hidden rounded-t-lg group-hover:scale-110">
                <Image
                  src={
                    item.thumbnail_large_url?.startsWith("http")
                      ? item.thumbnail_large_url
                      : `${process.env.NEXT_PUBLIC_API_KEY}${item.thumbnail_large_url}`
                  }
