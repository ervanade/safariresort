...
const PromoPopup = ({ dataPromo }) => {
  ...
  const dummyPromos = [
    ...
    },
    {
      id: 2,
      image:
        "https://horizons-cdn.hostinger.com/b05a0347-ff2a-4d3e-b189-510345403291/1df41e0bdf8643f50c57d11942921d44.png",
    ...
    },
    {
      id: 3,
      image:
        "https://horizons-cdn.hostinger.com/b05a0347-ff2a-4d3e-b189-510345403291/beef569d2f21968d7d4855f55f98f873.png",
  ...
  const promos = dataPromo.length ? mapPromo(dataPromo) : [];
            ...
            <div className="flex w-full">
              ...
              <div className="flex-1 flex flex-col p-4 md:p-5 relative">
                <AnimatePresence mode="wait">
                  ...
                  >
                    <h3
                      className="text-sm md:text-base font-bold text-[#7C3B1F] leading-tight mb-1 line-clamp-2"
