                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div className="mt-auto flex items-center justify-between gap-2">
                       ...
                       <button
                        className="px-3 py-1.5 bg-[#F06934] hover:bg-[#d65523] text-white text-[10px] md:text-xs font-bold rounded-lg transition-all duration-300 shadow-sm hover:shadow-md active:scale-95 whitespace-nowrap"
