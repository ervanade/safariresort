      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            className="relative h-[400px] md:h-[600px] w-full overflow-hidden shadow-2xl rounded-sm"
          >
            <img
              src={dataAbout?.img || "/assets/image-about.png"} // Ganti dengan path image baru Anda
              alt="Safari Resort Experience"
          ...
          >
            ...
            >
              {dataAbout?.title || `About Safari Resort`}
            </h2>
            <div
            ...
            >
              ...
              <p className="leading-relaxed">
                {dataAbout?.desc ||
                  `Safari Resort is a 4-star resort with unique room types of Caravan & Treehouse, building rooms and spacious rooms of Bungalows in the highland of Puncak. Standing on 8 hectares of land on the slopes of Mount Gede Pangrango, sensation of staying in a resort surrounded by Pines Forest, and inside The Great Taman Safari Bogor.`}
              </p>
