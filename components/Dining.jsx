  ...
  const highlights = [
    {
      ...
      description:
        "Masterfully crafted dishes by our expert chefs combining local flavors with international techniques.",
    },
    {
      icon: <ChefHat size={32} />,
      title: "Farm-to-Table",
      description:
        "Fresh, seasonal ingredients sourced directly from local organic farms and our own gardens.",
    },
    {
      icon: <Wine size={32} />,
      title: "Curated Selection",
      description:
        "An extensive collection of fine wines and signature cocktails to perfectly complement your meal.",
    },
    {
      icon: <Flame size={32} />,
        ...
        <section className="py-24 bg-white relative">
          <div className="container mx-auto px-4">
            <div className="text-center mb-20">
              <span className="text-[#F06934] font-bold text-sm tracking-widest uppercase mb-4 block">
                Why Dine With Us
              </span>
              <h2
                className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#7C3B1F]"
                style={{ fontFamily: "Mikado, sans-serif" }}
              >
