...
const Caravan = ({ dataRooms }) => {
  // Filter only Caravan type rooms
  const caravanRooms = dataRooms?.length
    ? mapAccommodationsToRooms(dataRooms)
    : roomsData.filter((room) => room.name.toLowerCase().includes("caravan"));
      ...
      <main className="pt-20">
        ...
        <section className="relative h-[60vh] min-h-[500px] overflow-hidden">
          ...
          <div className="relative container mx-auto px-4 h-full flex flex-col justify-center text-white">
            ...
            >
              Experience the thrill of camping without sacrificing comfort. Stay
              in our unique caravans for an unforgettable outdoor getaway.
            </motion.p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              <div className="bg-white p-8 shadow-sm border border-[#7C3B1F]/10 text-center group hover:bg-[#7C3B1F] transition-colors duration-300">
                ...
                <p
                  ...
                  style={{ fontFamily: "Nunito, sans-serif" }}
                >
                  Choose from classic caravans, rhino-themed units, or even a
                  transformed bus for a quirky stay.
                </p>
              </div>
              <div className="bg-white p-8 shadow-sm border border-[#7C3B1F]/10 text-center group hover:bg-[#7C3B1F] transition-colors duration-300">
                <div className="bg-[#faf7f5] w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-white/10 transition-colors">
                ...
                <p
                  ...
                  style={{ fontFamily: "Nunito, sans-serif" }}
                >
                  Perfectly situated for easy access to our safari parks and
              ...
              <div className="bg-white p-8 shadow-sm border border-[#7C3B1F]/10 text-center group hover:bg-[#7C3B1F] transition-colors duration-300">
                ...
                <p
                  ...
                  style={{ fontFamily: "Nunito, sans-serif" }}
                >
                  Enjoy the camping vibe with private terrace areas perfect for
                  evening relaxation.
                </p>
              </div>
            </div>
