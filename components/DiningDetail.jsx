      ...
      <main>
        ...
        <section className="relative h-[60vh] min-h-[500px]">
          <div className="absolute inset-0">
            <img
              src={dataRestaurant?.image_url}
              alt={dataRestaurant?.title}
              ...
              <div className="bg-[#FAF7F5] overflow-hidden shadow-lg">
                <div className="grid grid-cols-1 md:grid-cols-2">
                  <div className="h-64 md:h-auto">
                    <img
                      src={restaurantsData[0]?.romanticDinnerPackage.image}
                      alt="Romantic Dinner"
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <div className="p-8 md:p-12 flex flex-col justify-center">
                    <span className="text-[#F06934] font-bold tracking-widest uppercase mb-2">
                      Special Experience
                    </span>
                    <h2
                      className="text-3xl font-bold text-[#7C3B1F] mb-4"
                      style={{ fontFamily: "Mikado, sans-serif" }}
                    >
                      {restaurantsData[0]?.romanticDinnerPackage.title}
                    </h2>
                    <p className="text-gray-600 mb-6 text-lg">
                      {restaurantsData[0]?.romanticDinnerPackage.description}
                    </p>
            ...
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                ...
                <p className="text-gray-600">
                  Discover our chef's recommended dishes
                </p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {dataDining?.map((item, index) => (
                  <motion.div
                    key={index}
                    initial={{ opacity: 0, y: 20 }}
                  ...
                  >
                    ...
                    <div className="p-6">
                      <h3 className="text-xl font-bold text-[#7C3B1F] mb-2">
                        {item?.name}
                      </h3>
