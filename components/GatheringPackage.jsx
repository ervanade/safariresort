  ...
  const highlights = [
    {
      ...
      description: "Expert planners to handle logistics for groups of any size."
    },
    {
    ...
    },
    {
      ...
      description: "Custom schedules including dining, activities, and free time."
    },
    {
            ...
            {gatheringData.map((pkg, index) => (
              ...
              >
                <Card className="h-full border-none shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col group overflow-hidden bg-white">
                  ...
                  <CardHeader>
                    <CardTitle className="text-2xl text-[#7C3B1F]" style={{ fontFamily: 'Mikado, sans-serif' }}>{pkg.name}</CardTitle>
                    <CardDescription className="line-clamp-2 font-nunito">{pkg.description}</CardDescription>
                  </CardHeader>
                  ...
                  <CardFooter className="pt-0">
                    <Link href={`/packages/gathering/${pkg.slug}`} className="w-full">
        ...
        <section className="py-20 bg-white">
           <div className="container mx-auto px-4">
              <div className="text-center mb-16">
                 <h2 className="text-4xl font-bold text-[#7C3B1F] mb-4" style={{ fontFamily: 'Mikado, sans-serif' }}>The Perfect Venue</h2>
